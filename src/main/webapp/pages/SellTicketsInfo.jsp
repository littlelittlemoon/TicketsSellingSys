...
<body class="navbar" ms-controller="SellTicketsInfoController">
                        ...
                        <div class="table-responsive">
                            <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                ...
                                <tr ms-for="el in @datalist">
                                    ...
                                    <td class="hidden-480 center">已{{el.sellstyle.sname}}</td>
                                    ...
                                    <th class="center">{{el.ticketInfo.ticketid}}</th>
                                </tr>
                                </tbody>
                            </table>
                        </div>
...
<script src="<%=path%>/assets/myjs/SellTicketsInfo.js"></script>
